...
public class CustomAttributeProviderExtensionsTests
{
    ...
    private class TestDataClass : TestHelper.TestDataClass
    {
        protected override void Initialize()
        {
            ...
            TestData.Add([null, true, false]);
            TestData.Add([model.GetType(), false, true]);
            TestData.Add([model.GetType().GetField(nameof(VerificationModel.VerificationField)), false, true]);
            TestData.Add([model.GetType().GetProperty(nameof(VerificationModel.VerificationProperty)), false, true]);
            TestData.Add([model.GetType().GetMethod(nameof(VerificationModel.VerificationMethod)), false, true]);
            TestData.Add([child.GetType(), true, true]);
            TestData.Add([child.GetType(), false, false]);
            TestData.Add([child.GetType().GetField(nameof(VerificationModel.VerificationField)), true, true]);
            TestData.Add([child.GetType().GetField(nameof(VerificationModel.VerificationField)), false, true]);
            TestData.Add([child.GetType().GetProperty(nameof(VerificationModel.VerificationProperty)), true, false]);
            TestData.Add([child.GetType().GetProperty(nameof(VerificationModel.VerificationProperty)), false, false]);
            TestData.Add([child.GetType().GetMethod(nameof(VerificationModel.VerificationMethod)), true, true]);
            TestData.Add([child.GetType().GetMethod(nameof(VerificationModel.VerificationMethod)), false, false]);
        }
    }
